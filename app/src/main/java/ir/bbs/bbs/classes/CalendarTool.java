...
public class CalendarTool {
    ...
    public void setGregorianDate(String date) {
        String[] GregorianDate = date.split("-");
        gYear = Integer.parseInt(GregorianDate[0]);
        gMonth = Integer.parseInt(GregorianDate[1]);
        gDay = Integer.parseInt(GregorianDate[2]);
        JDN = gregorianDateToJDN(Integer.parseInt(GregorianDate[0]), Integer.parseInt(GregorianDate[1]), Integer.parseInt(GregorianDate[2]));
        JDNToIranian();
        JDNToJulian();
        JDNToGregorian();
    }
